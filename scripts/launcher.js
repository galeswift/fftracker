...
function load_cookie() {
	...
	for (var co in cs) {
		if (cs[co].indexOf('220') > -1 && cs[co].indexOf('settings') > -1) {
...
function launch(bUseBeta) {
	...
	open('tracker.html?f=' + flagsval.toUpperCase() + '&d=' + itemtracking + '&c=' + loctracking + '&s=' + bosstracking + '&l=' + locationtracking + '&v=' + verticallayout + '&h=' + charactertracking + '&o=' + objectivetracking + '&a=' + autotracking + autotrackingport + '&b=' + browser + '&beta='+bUseBeta,
		'',
